...
<div id="templatemo_container">
 ...
 <?php
  if(isset($_GET['catid']))
   ...
   $sql="SELECT * FROM news_articles WHERE catid='$catid'";
    $result=executequery($sql);
  while($data=mysql_fetch_assoc($result)){?>
	   <ul>
    <a href="news_contents.php?catid=<?php echo $data['aid']; ?>"> <?php echo $data['atitle'];?></a><p align="justify"><?php echo $data['adesc']; ?></p>
    </ul>
	<?php }}?>
