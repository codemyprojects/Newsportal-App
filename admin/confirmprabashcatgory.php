...
$sql = "insert into news_category_prabash (catid,catname,catdesc,status,image) values (null,'$catname','$catdesc',1,'$imagename
')";
...
header("location:manageprabash.php?msg=page added successfully");}?>