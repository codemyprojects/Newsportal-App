...
$sql = "insert into news_category (catid,catname,catdesc,status,image) values (null,'$catname','$catdesc',1,'$imagename
')";
...
header("location:managecategory.php?msg=page added successfully");}?>