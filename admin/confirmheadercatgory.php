...
$sql = "insert into news_header_category (catid,catname,catdesc,status,image) values (null,'$catname','$catdesc',1,'$imagename
')";
...
header("location:addnewsheadercategory.php?msg=page added successfully");}?>