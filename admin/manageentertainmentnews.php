...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addentertainmentcategory.php"><h1>ADD New Category</h1></a></p>
	<table width="100%">
		<tr>
			<th>Category-name</th>
			<th>Status</th>
	...
	<?php
		...
		<tr>
			...
			<td><a href="editentertainmentcategory.php?catid=<?php echo $catid; ?>">Edit</a></td>
			<td><a href="javascript:void(0)" onclick="chk('deleteentertainmentcategory.php?catid=<?php echo $catid;?>')">Delete</a></td>
          	</tr>
<?php } ?>
	</table>
	</div>
