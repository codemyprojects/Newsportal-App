...
$sql = "insert into news_category_cultural (catid,catname,catdesc,status,image) values (null,'$catname','$catdesc',1,'$imagename
')";
...
header("location:manageculturalcategory.php?msg=page added successfully");}?>