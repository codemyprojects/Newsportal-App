...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addcategory.php"><h1>ADD New Category</h1></a></p>
	<table width="100%">
		<tr>
			<th>Category-name</th>
			<th>Status</th>
	...
	<?php
		...
		<tr>
			<td><strong><a href="managearticles1.php?catid=<?php echo $datacategory['catid'];?>"><?php echo $datacategory['catname'];?></a></strong></td>
			...
			<td><a href="editcategory.php?catid=<?php echo $catid; ?>">Edit</a></td>
			<td><a href="javascript:void(0)" onclick="chk('deletecategory.php?catid=<?php echo $catid;?>')">Delete</a></td>
          	</tr>
<?php } ?>
	</table>
	</div>
