...
<div class="wrapper">
	...
	<div class="content">
	<form name="frmpage" method="post" enctype="multipart/form-data" action="confirmarticle.php">
    ...
    <input type="hidden" name="aid" value="" />-->
		...
		<table>
			<tr>
				...
				?>
				<option value="<?php echo $datacategory['pid'];?>"><?php echo $datacategory['pagetitle'];?></option>
				<?php } ?>
				</select>
