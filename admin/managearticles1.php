...
if(isset($_GET['catid'])) {
	$catid = $_GET['catid'];
	$sql = "select * from news_home_articles1 where catid='$catid' order by atitle desc";
}else {
$sql = "select * from news_home_articles1";
}
...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addarticle.php"><h1>Add New Articles</h1></a></p>
	<table width="100%">
		<tr>
			<th>Article Title</th>
	...
	<?php
		...
		<tr>
			...
			if($status==1) {
			?>
			<a href="updatestatus.php?aid=<?php echo $dataarticle['aid'];?>&status=0,&page=articles">Active</a>
			<?php
			}//end of if
			else {
			?>
			...
			<td><a href="editarticles.php?aid=<?php echo $dataarticle['aid'];?>">Edit</a></td>
			<td><a href="javascript:void(0)" onclick="chk('deletearticles.php?aid=<?php echo $aid;?>')">Delete</a></td>
		</tr>
<?php } ?>
	</table>
	</div>
