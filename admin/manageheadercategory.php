...
$sql = "select * from news_header_category";
...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addnewsheadercategory.php"><h1>ADD New Category</h1></a></p>
	<table width="100%">
		<tr>
			<th>Category-name</th>
			<th>Status</th>
	...
	<?php
		...
		<tr>
			<td><strong><a href="news_articles_header.php?catid=<?php echo $datacategory['catid'];?>"><?php echo $datacategory['catitle'];?></a></strong></td>
			...
			<td><a href="editheadercategory.php?catid=<?php echo $catid; ?>">Edit</a></td>
			<td><a href="javascript:void(0)" onclick="chk('deleteheadercategory.php?catid=<?php echo $catid;?>')">Delete</a></td>
          	</tr>
<?php } ?>
	</table>
	</div>
