...
if(isset($_GET['catid'])) {
	$catid = $_GET['catid'];
	$sql = "select * from  news_cultural_articles where catid='$catid' order by atitle desc";
}else {
$sql = "select * from  news_cultural_articles";
}
...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addculturaltarticle.php"><h1>Add New Articles</h1></a></p>
	<table width="100%">
		<tr>
			<th>Article Title</th>
	...
	<?php
		...
		<tr>
			...
			<td><a href="editculturalarticles.php?aid=<?php echo $dataarticle['aid'];?>">Edit</a></td>
			<td><a href="javascript:void(0)" onclick="chk('deleteculturalarticles.php?aid=<?php echo $aid;?>')">Delete</a></td>
		</tr>
<?php } ?>
	</table>
	</div>
