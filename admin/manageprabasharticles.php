...
if(isset($_GET['catid'])) {
	$catid = $_GET['catid'];
	$sql = "select * from  news_prabash_articles where catid='$catid' order by atitle desc";
}else {
$sql = "select * from  news_prabash_articles";
}
...
<div class="wrapper">
	...
	<div class="content">
	<p><a href="addprabasharticle.php"><h1>Add New Articles</h1></a></p>
	<table width="100%">
		<tr>
			<th>Article Title</th>
	...
	<?php
		...
		<tr>
			...
			<td><a href="editprabasharticles.php?aid=<?php echo $dataarticle['aid'];?>">Edit</a></td>
