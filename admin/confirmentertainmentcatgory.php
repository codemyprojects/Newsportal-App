...
$sql = "insert into news_category_entertainment (catid,catname,catdesc,status,image) values (null,'$catname','$catdesc',1,'$imagename
')";
...
header("location:manageentertainmentnews.php?msg=page added successfully");}?>