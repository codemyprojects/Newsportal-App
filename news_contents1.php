...
$datappage = getPageContentById($catid);
 ...
 $sql="SELECT * FROM  news_home_articles1 WHERE catid='$catid'";
 ...
 while($data=mysql_fetch_assoc($result)){
  ...
  //die();
 ?>
 <ul><li><a href="news_contents1.php?aid=<?php echo $data['aid']?>"><?php echo $data['atitle']; ?></a></li></ul>
 <?php }}?>
 ...
 <?php if(isset($_GET['aid'])){ 
  $aid=$_GET['aid'];
  $sql="SELECT * FROM news_home_articles1 WHERE aid='$aid' ";
  $result=mysql_query($sql);
