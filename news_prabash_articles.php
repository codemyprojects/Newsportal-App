...
$datappage = getPageContentById($catid);
 ...
 $sql="SELECT * FROM   news_prabash_articles WHERE catid='$catid'";
 ...
 while($data=mysql_fetch_assoc($result)){
  ...
  //die();
 ?>
 <ul><li><a href="news_prabash_articles.php?aid=<?php echo $data['aid']?>"><?php echo $data['atitle']; ?></a></li></ul>
 <?php }}?>
 ...
 <?php if(isset($_GET['aid'])){ 
  $aid=$_GET['aid'];
  $sql="SELECT * FROM  news_prabash_articles WHERE aid='$aid' ";
  $result=mysql_query($sql);
